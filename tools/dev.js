...
const utf8b64encode = (s) => btoa(String.fromCodePoint(...new TextEncoder().encode(s)));
  ...
  mount(root) {
    ...
    root.append(field('ورودی', ta),
      el('div', { class: 'dash-actions' },
        ...
        el('button', { class: 'btn tonal sm', onclick: () => { const d = document.createElement('textarea'); d.innerHTML = ta.value; out.set(d.value); } }, 'Unescape')),
      out.root);
  }
});
