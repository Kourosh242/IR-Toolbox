...
function pageSec() {
  ...
  return el('div', {},
    ...
    el('div', { class: 'card', style: 'padding:8px 20px' },
      ...
      row('🧰', 'گاوصندوق IR', 'رمزنگاری با PBKDF2-HMAC-SHA-256 (۲۵۰۰۰۰ تکرار) برای مشتق کلید + AES-256-GCM برای رمزنگاری، با salt و IV تصادفی برای هر فایل. رمز عبور و کلید هرگز ذخیره نمی‌شوند؛ فراموشی رمز یعنی از دست رفتن داده — این یک ویژگی امنیتی است، نه باگ.'),
