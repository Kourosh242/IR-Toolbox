...
/* v1.3.4: hook پاک‌سازی برای ابزارهای دارای تایمر — هنگام ناوبری فراخوانی می‌شود */
let _cleanup = null;
export const setCleanup = (fn) => { _cleanup = fn; };
export const runCleanup = () => { if (_cleanup) { try { _cleanup(); } catch {} _cleanup = null; } };
