...
export function offInstallAvailable(fn) { listeners.delete(fn); } // fix: امکان آزادکردن listener صفحهٔ خانه
...
export async function promptInstall() {
  ...
  } catch { deferredPrompt = null; return false; } // fix: prompt() فقط یک‌بار قابل فراخوانی است؛ خطای بار دوم بی‌صدا مدیریت می‌شود
}
